...
public class CloseFrame extends Effect {

    static {
        Skript.registerEffect(CloseFrame.class, "[(skwindow)] (close) %~frame%");
    }
    ...
    public String toString(@Nullable Event event, boolean debug) {
        return "effect: CloseFrame , Expression: " + frameexpr.toString(event, debug);
    }
