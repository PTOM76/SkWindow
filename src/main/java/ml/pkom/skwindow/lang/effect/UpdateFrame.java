...
public class UpdateFrame extends Effect {

    static {
        Skript.registerEffect(UpdateFrame.class, "[(skwindow)] (update) %~frame%");
    }
    ...
    public String toString(@Nullable Event event, boolean debug) {
        return "effect: UpdateFrame , Expression: " + frameexpr.toString(event, debug);
    }
